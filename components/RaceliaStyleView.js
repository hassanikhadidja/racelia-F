export function createRaceliaStyleView() {
  ...
  view.innerHTML = `
    <form class="style-search" id="styleSearchForm">
      <input id="styleSearchInput" type="text" placeholder="Search" />
      <button type="submit" class="style-search__btn" aria-label="Search">
        <svg viewBox="0 0 24 24"><circle cx="11" cy="11" r="7"/><path d="M21 21l-4.3-4.3"/></svg>
      </button>
    </form>

    <h1 class="style-title">BE A RACÈLIACREATOR!</h1>
    <p class="style-lede">
      Inspire us with your best look! Share your RACÈLIA looks with the hashtag
      #raceliastyle and tag @racelia
    </p>
  ...
  sheet.innerHTML = `
    <div class="style-sheet-scroll">
      <div class="style-sheet-hero-wrap">
        ...
        <button class="style-sheet-close" id="styleSheetClose" type="button" aria-label="Close">
      ...
      <div class="style-sheet-head">
        <h2 id="styleSheetTitle">GET YOUR RACÈLIASTYLE</h2>
        <span class="style-sheet-count" id="styleSheetCount">2 PRODUCTS</span>
      </div>
